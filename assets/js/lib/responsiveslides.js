    ...
    return this.each(function () {
      ...
      if ($slide.size() > 1) {
        ...
        if (settings.nav) {
          ...
          // Inject navigation
          if (options.navContainer) {
/*             $(settings.navContainer).append(navMarkup); CUSTOMIZED THIS TO ALLOW MULTIPLE CAROUSELS ON ONE PAGE*/
            $(this).siblings('.work-header').children('.work-nav').append(navMarkup);
