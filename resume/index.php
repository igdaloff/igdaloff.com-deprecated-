...
<html>
 	<head>
 		<meta charset="utf-8">
 		<title>Nathan Igdaloff - UX Designer / Web Developer</title>
 				...
 				<div class="resume-section">
	 				...
	 				<div class="resume-content">
	 					<div class="resume-content-item">
				 			...
				 			<h3>Made Movement</h3>
				 			<h4>Creative Technologist, Technical&nbsp;Lead</h4>
				 			<ul>
	 					...
	 					<div class="resume-content-item">
				 			...
				 			<h3>M<sub>c</sub>Gladrey & Pullen</h3>
				 			<h4>Senior IT Consultant</h4>
				 			<ul>
 				...
 				<div class="resume-section">
	 				...
	 				<div class="resume-content">
	 					<div class="resume-content-item">
				 			...
				 			<h4>Graduate, Design and Development</h4>
